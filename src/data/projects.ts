...
export const projects: Project[] = [
  ...
  //   title: 'Recipe Finder',
  //   description:
  //     'Discover and save recipes with advanced filtering, nutritional info, and step-by-step cooking mode.',
  //   image:
  ...
  //   description:
  //     'A drag-and-drop portfolio generator for developers with custom themes and one-click deployment.',
  //   image:
